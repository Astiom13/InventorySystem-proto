...
void UInv_SlottedItem::NativeOnMouseEnter(const FGeometry& InGeometry, const FPointerEvent& MouseEvent)
{
...
void UInv_SlottedItem::SetImageBrush(FSlateBrush& Brush) const
{
