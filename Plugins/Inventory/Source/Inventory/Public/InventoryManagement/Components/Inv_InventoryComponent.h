...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FItemEquipedStatusChanged, UInv_InventoryItem*, Item);
...
public:
	...
	FItemEquipedStatusChanged OnItemEquipped;
	FItemEquipedStatusChanged OnItemUnequipped;
