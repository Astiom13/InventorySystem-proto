...
/*
*	Item fragment specifically for assimilation into the widget
 */
...
private:
	...
	TArray<TInstancedStruct<FInv_ConsumableModifier>> ConsumeModifiers;
};

USTRUCT(blueprintType)
struct FInv_HealthPotionFragment : public FInv_ConsumableModifier
{
	GENERATED_BODY()
...
USTRUCT(blueprintType)
struct FInv_ManaPotionFragment : public FInv_ConsumableModifier
{
	GENERATED_BODY()
